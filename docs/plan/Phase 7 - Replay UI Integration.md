...
役割分担は §7 の `[AI 作業分担]` を参照。AI がステップ 1–2 を実行し、ステップ 3 はユーザーに依頼する。
...
**ステップ 2: Rust アプリ起動（ユーザーが PowerShell で実行）**
...
1. `Open Strategy...` → `python/tests/data/test_strategy_daily.py`
2. `Run` ボタンを押す
