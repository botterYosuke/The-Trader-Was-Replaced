...
- **Phase A-full（未）**: App 組み立てとトランスポートタスクを `main.rs` から lib へ抽出し、
  ...
  - **ここで初めて pin できる未カバー挙動**: `ListAllListedSymbols` が end_date を clamp（未来日→Catalog 最新日, ADR-0001）した
