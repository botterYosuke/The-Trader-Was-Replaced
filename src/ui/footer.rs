...
use crate::ui::components::{
    ExecutionModeToggleSegment, FooterRoot, GrpcStatusLabel, InstrumentRegistry, PauseResumeButton,
    PauseResumeLabel, ReplayStateBadge, ReplayTimeLabel, ScenarioMetadata, SpeedButton,
    StepFromIdleRequested, StrategyBuffer, StrategyEditorId, StrategyFragment,
